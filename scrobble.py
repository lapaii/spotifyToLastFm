...
dataBlocks = os.listdir("blocks/")

newestBlock = dataBlocks[0];

with open(f"blocks/{newestBlock}", encoding='utf-8') as file:
...
print("done scrobbling!")
os.remove(f"blocks/{newestBlock}")